...
module.exports = {
    ...
    OnMessage(message) {
        ...
        if (message.content == "Van a jugar a matarse entre ustedes para siempre upupupu") {
            message.channel.send("@Participante chicos, tienen que desactivar el módulo killingGame para terminar el juego. Le regresaré temporalmente el Admin a PotatoGirl para que lo haga, pero deben apurarse. Usen |help si necesitan mi ayuda.")
        }
