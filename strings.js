...
└──┴──┴──┴──┴──┴──┴──┘`,
		...
		DAEMON_DICE: {
			...
			PARTY: {
				...
				DISBANDED: " perished and was removed from your party T_T",
			},
			...
			QUESTS_1: [
				...
				"hurt Vegeta's pride",
				"completed the pokedex",
				"played P.T. demo",
				"was bitten by a non-underaged vampire",
				"did push-ups one-handed",
				"ate the devil's fruit",
				"got stuck in a school-like limbo",
				"saw the ghost of an old friend",
				"rejuvenated to the age of 7",
				"enrolled in the hero licence exam",
				"fell in love with an android",
				"fell ill of chuunibyou's",
				"declared war to Britannia",
				"made a cameo in an anime opening",
				"sang karaoke in japanese",
				"hit the little toe against the door",
				"decided to play Yasuo",
				"rubbed his cat's belly",
				"was the student council president",
				"transferred to a cooking school",
				"worked as a rental girlfriend",
				"made a blood pact with his school uniform",
				"shared apartment with a dragon",
				"transferred his consciousness into a machine",
				"swallowed a thousand needles",
				"forgot to delete his browsing history",
				"received magical girl powers",
				"controlled weather at will",
				"worked as an auto memory doll",
				"summoned the Old Gods",
				"gathered the fragments of a cursed pearl",
				"adopted the perfect child",
				"traveled to Antarctica with his friends",
				"worked in a maid cafe",
				"learned the karuta poems",
				"performed alchemy to revive a loved one",
				"acquired the ability to see spirits",
				"gave private lessons to quintuplets",
				"donated blood on an empty stomach",
				"shared his Netflix account",
				"stepped on an insect barefoot",
				"wrote on the wrong chat",
				"maxed out the most useless ability",
				"visited the Ender Dragon",
				"lost his passport in a foreign country",
				"published a manga about his own life",
				"dominated the four elements",
				"tried to kill his sensei",
				"participated in Monokuma's killing game",
				"voted for the wrong crew member",
...
└──┴──┴──┴──┴──┴──┴──┘`,
		...
		DAEMON_DICE: {
			...
			PARTY: {
				...
				DISBANDED: " ha perdido y fue removido de tu grupo T_T",
			},
			...
			QUESTS_1: [
				...
				"hirió el orgullo de Vegeta",
				"completó la pokedex",
				"jugó al P.T. demo",
				"fue mordido por un vampiro mayor de edad",
				"hizo flexiones con una mano",
				"comió la fruta del diablo",
				"quedó atrapado en un limbo escolar",
				"vió el fantasma de un viejo amigo",
				"rejuveció hasta los 7 años",
				"hizo el examen de licencia para héroes",
				"se enamoró de un androide",
				"enfermó de chuunibyou",
				"declaró la guerra a Britannia",
				"hizo un cameo en un opening de animé",
				"cantó karaoke en japonés",
				"se golpeó el dedo pequeño del pie con la puerta",
				"decidió jugar Yasuo",
				"acarició la panza de su gato",
				"fue presidente del centro estudiantil",
				"se transfirió a una escuela de cocina",
				"trabajó como novia de alquiler",
				"hizo un pacto de sangre con su uniforme escolar",
				"compartió departamento con un dragón",
				"transfirió su conciencia a una máquina",
				"se tragó mil agujas",
				"olvidó borrar su historial de navegación",
				"recibió poderes de chica mágica",
				"controló el clima a voluntad",
				"trabajó de auto memory doll",
				"invocó a los Viejos Dioses",
				"juntó los fragmentos de una perla maldita",
				"adoptó a la niña perfecta",
				"viajó a la Antártida con sus amigos",
				"trabajó en un maid café",
				"aprendió los poemas del karuta",
				"usó alquimia para revivir a un ser querido",
				"adquirió la capacidad de ver espíritus",
				"dio clases privadas a quintillizas",
				"donó sangre en ayunas",
				"compartió su cuenta de Netflix",
				"pisó un insecto descalzo",
				"escribió en el chat equivocado",
				"maxeó la habilidad más inútil",
				"visitó al Ender Dragon",
				"perdió su pasaporte en un país extranjero",
				"publicó un manga sobre su vida",
				"dominó los cuatro elementos",
				"intentó asesinar a su sensei",
				"participó en el juego de Monokuma",
				"votó por el tripulante equivocado",
				"engañó a la Muerte en Persona",
			],
			ITEMS_1: [
				"pokébola",
				"placa de video ostentosa",
				"sustancia no-ilegal",
				"ojo de Cthulhu",
